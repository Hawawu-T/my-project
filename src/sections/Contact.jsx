    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} pb-20`}>
      <section id='contact' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} lg:w-[95%] w-full h-fit m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:px-36 px-6 py-20 gap-10`}>
        ...
        <h1 className='text-2xl text-black font-semibold dark:text-white'>Send us a message today</h1>
          ...
          <input type='text' placeholder='Enter your valid number'
          className='w-full px-6 py-3 border-2 border-gray-200 rounded-xl'/>
          <input type='text' placeholder='Enter your valid image'
          className='w-full px-6 py-3 border-2 border-gray-200 rounded-xl'/>
          <textarea name='' id='' cols='30' rows='5' placeholder='
          Enter your message here...' className='w-full px-6 py-3 border-2 border-gray-200 rounded-xl'></textarea>
        ...
        <div className='flex flex-col justify-center items-start gap-8 lg:p-20 p-6'>
          ...
          <h1 data-aos='zoom-in' data-aos-delay='400' className='text-black text-[40px] font-semibold leading-10 dark:text-white'>Lorem ipsum dolor, sit amet consectetur adipisicing eli itaque praesentium?</h1>
          <p data-aos='zoom-in' data-aos-delay='600' className='text-xl text-gray-600 text-justify dark:text-white'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Molestiae, molestias excepturi. Aperiam aliquam nisi accusantium iure pariatur quasi totam assumenda rem quam nostrum, doloribus architecto, deleniti perferendis voluptatem, ad quod!</p>
          <button className='bg-red-600 w-full text-md px-8 py-3 text-white font-semibold rounded-xl hover:bg-black dark:hover:bg-red-700 cursor-pointer'>SEND EMAIL</button>
