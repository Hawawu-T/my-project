...
import area1 from '../assets/images/images/area1.jpg'
import area2 from '../assets/images/images/area2.jpg'
import area3 from '../assets/images/images/area3.jpg'
import  AOS from 'aos'
...
const Popular = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section className={`${darkMode ? 'dark bg-gre-800' : 'light bg-red-100'} lg:w-[90%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-center lg:px-20 py-20 gap-20`}>
        <div id='top' className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8'>
          ...
          <h1 data-aos='zoom-in' className='text-black text-[40px] font-semibold loading-10 mt-4 dark:text-white'>Explore the most <br></br>popular areas</h1>
          </div>  
        ...
        <div id='buttom' className='w-full grid lg:grid-cols-3 grid-cols-1 lg:justify-center justify-start items-start ga-6'>
