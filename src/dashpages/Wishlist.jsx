...
const Wishlist = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'bg-transparent'}`}>
      <div className="flex flex-col mx-auto pb-6 pt-6 md:p-6 lg:p-12 w-full">
        <Link to="/">
          <button className="items-center font-sans text-3xl font-bold">
            <FaArrowLeft size={24} />
          </button>
        </Link>
        <h1 className="text-3xl font-bold text-center mb-4">Wishlist</h1>
        <ul className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-40">
